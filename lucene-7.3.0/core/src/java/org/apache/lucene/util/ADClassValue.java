// Source: https://github.com/bpupadhyaya/openjdk-8/blob/master/jdk/src/share/classes/java/lang/ClassValue.java
...
import org.apache.lucene.util.ADClassValue.ClassValueMap;
import java.util.WeakHashMap;
import java.lang.ref.WeakReference;
import java.util.concurrent.atomic.AtomicInteger;

import static org.apache.lucene.util.ADClassValue.ClassValueMap.probeHomeLocation;
import static org.apache.lucene.util.ADClassValue.ClassValueMap.probeBackupLocations;
 ...
 * @since 1.7
 */
public abstract class ADClassValue<T> {
    /**
    ...
    public T get(Class<?> type) {
        ...
        org.apache.lucene.util.ADClassValue.Entry<?>[] cache;
        org.apache.lucene.util.ADClassValue.Entry<T> e = probeHomeLocation(cache = getCacheCarefully(type), this);
    ...
    private static org.apache.lucene.util.ADClassValue.Entry<?>[] getCacheCarefully(Class<?> type) {
        // racing type.classValueMap{.cacheArray} : null => new Entry[X] <=> new Entry[Y]
        //ClassValueMap map = type.classValueMap;
        ClassValueMap map = null;
        if (map == null)  return EMPTY_CACHE;
        org.apache.lucene.util.ADClassValue.Entry<?>[] cache = map.getCache();
        return cache;
    ...
    private static final org.apache.lucene.util.ADClassValue.Entry<?>[] EMPTY_CACHE = { null };
     ...
     */
    private T getFromBackup(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, Class<?> type) {
        org.apache.lucene.util.ADClassValue.Entry<T> e = probeBackupLocations(cache, this);
        if (e != null)
            return e.value();
    ...
    org.apache.lucene.util.ADClassValue.Entry<T> castEntry(org.apache.lucene.util.ADClassValue.Entry<?> e) { return (org.apache.lucene.util.ADClassValue.Entry<T>) e; }
    ...
    private T getFromHashMap(Class<?> type) {
        ...
        ClassValueMap map = getMap(type);
        for (;;) {
            org.apache.lucene.util.ADClassValue.Entry<T> e = map.startEntry(this);
            if (!e.isPromise())
                return e.value();
            try {
    ...
    boolean match(org.apache.lucene.util.ADClassValue.Entry<?> e) {
    ...
    static class Version<T> {
        private final ADClassValue<T> classValue;
        private final org.apache.lucene.util.ADClassValue.Entry<T> promise = new org.apache.lucene.util.ADClassValue.Entry<>(this);
        Version(ADClassValue<T> classValue) { this.classValue = classValue; }
        ADClassValue<T> classValue() { return classValue; }
        org.apache.lucene.util.ADClassValue.Entry<T> promise() { return promise; }
    ...
    static class Entry<T> extends WeakReference<Version<T>> {
        ...
        ADClassValue<T> classValueOrNull() {
            Version<T> v = version();
        ...
        org.apache.lucene.util.ADClassValue.Entry<T> refreshVersion(Version<T> v2) {
            assertNotPromise();
            @SuppressWarnings("unchecked")  // if !isPromise, type is T
            org.apache.lucene.util.ADClassValue.Entry<T> e2 = new org.apache.lucene.util.ADClassValue.Entry<>(v2, (T) value);
            clear();
            // value = null -- caller must drop
            return e2;
        }
        static final org.apache.lucene.util.ADClassValue.Entry<?> DEAD_ENTRY = new org.apache.lucene.util.ADClassValue.Entry<>(null, null);
    }
    ...
    static <T> org.apache.lucene.util.ADClassValue.Entry<T> makeEntry(Version<T> explicitVersion, T value) {
        // Note that explicitVersion might be different from this.version.
        return new org.apache.lucene.util.ADClassValue.Entry<>(explicitVersion, value);
     ...
     */
    static class ClassValueMap extends WeakHashMap<ADClassValue.Identity, org.apache.lucene.util.ADClassValue.Entry<?>> {
        private final Class<?> type;
        private org.apache.lucene.util.ADClassValue.Entry<?>[] cacheArray;
        private int cacheLoad, cacheLoadLimit;

        /** Number of entries initially allocated to each type when first used with any Class__Value.
         *  It would be pointless to make this much smaller than the Class and Class__ValueMap objects themselves.
        ...
        org.apache.lucene.util.ADClassValue.Entry<?>[] getCache() { return cacheArray; }

        /** Initiate a query.  Store a promise (placeholder) if there is no value yet. */
        synchronized
        <T> org.apache.lucene.util.ADClassValue.Entry<T> startEntry(ADClassValue<T> classValue) {
            @SuppressWarnings("unchecked")  // one map has entries for all value types <T>
            org.apache.lucene.util.ADClassValue.Entry<T> e = (org.apache.lucene.util.ADClassValue.Entry<T>) get(classValue.identity);
        ...
        synchronized
        <T> org.apache.lucene.util.ADClassValue.Entry<T> finishEntry(ADClassValue<T> classValue, org.apache.lucene.util.ADClassValue.Entry<T> e) {
            @SuppressWarnings("unchecked")  // one map has entries for all value types <T>
            org.apache.lucene.util.ADClassValue.Entry<T> e0 = (org.apache.lucene.util.ADClassValue.Entry<T>) get(classValue.identity);
            if (e == e0) {
        ...
        /** Remove an entry. */
        synchronized
        void removeEntry(ADClassValue<?> classValue) {
            org.apache.lucene.util.ADClassValue.Entry<?> e = remove(classValue.identity);
            if (e == null) {
        ...
        synchronized
        <T> void changeEntry(ADClassValue<T> classValue, T value) {
            @SuppressWarnings("unchecked")  // one map has entries for all value types <T>
            org.apache.lucene.util.ADClassValue.Entry<T> e0 = (org.apache.lucene.util.ADClassValue.Entry<T>) get(classValue.identity);
            ...
            org.apache.lucene.util.ADClassValue.Entry<T> e = makeEntry(version, value);
            put(classValue.identity, e);
            // Add to the cache, to enable the fast path, next time.
            checkCacheLoad();
            addToCache(classValue, e);
        ...
        static org.apache.lucene.util.ADClassValue.Entry<?> loadFromCache(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, int i) {
        ...
        static <T> org.apache.lucene.util.ADClassValue.Entry<T> probeHomeLocation(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, ADClassValue<T> classValue) {
        ...
        static <T> org.apache.lucene.util.ADClassValue.Entry<T> probeBackupLocations(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, ADClassValue<T> classValue) {
            if (PROBE_LIMIT <= 0)  return null;
            // Probe the cache carefully, in a range of slots.
            int mask = (cache.length-1);
            int home = (classValue.hashCodeForCache & mask);
            org.apache.lucene.util.ADClassValue.Entry<?> e2 = cache[home];  // victim, if we find the real guy
            if (e2 == null) {
            ...
            for (int i = home + 1; i < home + PROBE_LIMIT; i++) {
                org.apache.lucene.util.ADClassValue.Entry<?> e = cache[i & mask];
                if (e == null) {
                ...
                if (classValue.match(e)) {
                    ...
                    cache[home] = e;
                    if (pos2 >= 0) {
                        cache[i & mask] = org.apache.lucene.util.ADClassValue.Entry.DEAD_ENTRY;
                    } else {
                        pos2 = i;
                    }
                    cache[pos2 & mask] = ((entryDislocation(cache, pos2, e2) < PROBE_LIMIT)
                                          ? e2                  // put e2 here if it fits
                                          : org.apache.lucene.util.ADClassValue.Entry.DEAD_ENTRY);
        ...
        private static int entryDislocation(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, int pos, org.apache.lucene.util.ADClassValue.Entry<?> e) {
            ADClassValue<?> cv = e.classValueOrNull();
        ...
        private void sizeCache(int length) {
            ...
            cacheArray = new org.apache.lucene.util.ADClassValue.Entry<?>[length];
        }
        ...
        private void reduceCacheLoad() {
            ...
            if (cacheLoad < cacheLoadLimit)
                return;  // win
            org.apache.lucene.util.ADClassValue.Entry<?>[] oldCache = getCache();
            if (oldCache.length > HASH_MASK)
                return;  // lose
            sizeCache(oldCache.length * 2);
            for (org.apache.lucene.util.ADClassValue.Entry<?> e : oldCache) {
                if (e != null && e.isLive()) {
                    addToCache(e);
                }
            }
         ...
         */
        private void removeStaleEntries(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, int begin, int count) {
            ...
            for (int i = begin; i < begin + count; i++) {
                ...
                org.apache.lucene.util.ADClassValue.Entry<?> replacement = null;
                if (PROBE_LIMIT > 1) {
         ...
         */
        private org.apache.lucene.util.ADClassValue.Entry<?> findReplacement(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, int home1) {
            org.apache.lucene.util.ADClassValue.Entry<?> replacement = null;
            int haveReplacement = -1, replacementPos = 0;
            int mask = (cache.length-1);
            for (int i2 = home1 + 1; i2 < home1 + PROBE_LIMIT; i2++) {
                org.apache.lucene.util.ADClassValue.Entry<?> e2 = cache[i2 & mask];
            ...
            if (haveReplacement >= 0) {
                if (cache[(replacementPos+1) & mask] != null) {
                    ...
                    cache[replacementPos & mask] = (org.apache.lucene.util.ADClassValue.Entry<?>) org.apache.lucene.util.ADClassValue.Entry.DEAD_ENTRY;
                } else {
        ...
        private void removeStaleEntries(ADClassValue<?> classValue) {
            removeStaleEntries(getCache(), classValue.hashCodeForCache, PROBE_LIMIT);
        }

        /** Remove all stale entries, everywhere. */
        private void removeStaleEntries() {
            org.apache.lucene.util.ADClassValue.Entry<?>[] cache = getCache();
            removeStaleEntries(cache, 0, cache.length + PROBE_LIMIT - 1);
        }

        /** Add the given entry to the cache, in its home location, unless it is out of date. */
        private <T> void addToCache(org.apache.lucene.util.ADClassValue.Entry<T> e) {
            ADClassValue<T> classValue = e.classValueOrNull();
            if (classValue != null)
                addToCache(classValue, e);
        }

        /** Add the given entry to the cache, in its home location. */
        private <T> void addToCache(ADClassValue<T> classValue, org.apache.lucene.util.ADClassValue.Entry<T> e) {
            if (PROBE_LIMIT <= 0)  return;  // do not fill cache
            // Add e to the cache.
            org.apache.lucene.util.ADClassValue.Entry<?>[] cache = getCache();
            int mask = (cache.length-1);
            int home = classValue.hashCodeForCache & mask;
            org.apache.lucene.util.ADClassValue.Entry<?> e2 = placeInCache(cache, home, e, false);
         ...
         */
        private org.apache.lucene.util.ADClassValue.Entry<?> placeInCache(org.apache.lucene.util.ADClassValue.Entry<?>[] cache, int pos, org.apache.lucene.util.ADClassValue.Entry<?> e, boolean gently) {
            org.apache.lucene.util.ADClassValue.Entry<?> e2 = overwrittenEntry(cache[pos]);
            if (gently && e2 != null) {
         ...
         *  in its place.
         */
        private <T> org.apache.lucene.util.ADClassValue.Entry<T> overwrittenEntry(org.apache.lucene.util.ADClassValue.Entry<T> e2) {
